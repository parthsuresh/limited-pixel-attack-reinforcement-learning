...
class AdvGAN_Pretrain:
    ...
    def train(self, train_dataloader, epochs):
        writer = SummaryWriter(log_dir="visualization/pre_advgan/", comment='Pretrained AdvGAN stats')
        ...
        for epoch in range(1, epochs+1):
            ...
            # save generator
            if epoch%20==0:
                netG_file_name = models_path + 'netG_pretrained_epoch_' + str(epoch) + '.pth'
                torch.save(self.netG.state_dict(), netG_file_name)
                netDisc_file_name = models_path + 'netDisc_pretrained_epoch_' + str(epoch) + '.pth'
